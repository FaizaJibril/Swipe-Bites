...
public class WebImageDaoJdbc implements WebImageDao {
    ...
    @Autowired
    public WebImageDaoJdbc(NamedParameterJdbcTemplate jdbcTemplate) {
    ...
    public List<WebImage> getWebImages(){
        String sql = "select i.image_id,i.file_name,i.mime_type,i.file_blob,i.file_size from image i where active = true;";
        Map<String,Object> params = new HashMap<>();
    ...
    public WebImage saveWebImage(WebImage webImage){
        String sql = "insert into image (file_name, mime_type, file_size, file_blob, active) values (:file_name, :mime_type, :file_size, :file_blob, true) returning image_id;";
        Map<String,Object> params = new HashMap<>();
    ...
    public void deleteWebImage(Long id){
        String sql = "update image set active = false where image_id = :id;";
        Map<String,Object> params = new HashMap<>();
